...
public class FilePathTreeItem extends TreeItem<String> {
	public static Image folderCollapseImage=new Image(ClassLoader.getSystemResourceAsStream("add.png"));
    public static Image folderExpandImage=new Image(ClassLoader.getSystemResourceAsStream("add.png"));
    public static Image fileImage=new Image(ClassLoader.getSystemResourceAsStream("add.png"));
